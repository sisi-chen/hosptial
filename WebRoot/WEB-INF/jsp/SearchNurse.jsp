...
function toManagementDoctor()
	 ...
	 function toLogistic()
 {
	 ...
	 function fun(){
  	 ...
  	 function toModifyNurse(){
  		window.location.href = 'ModifyNurse'; 
  	 }
	</script>
...
<div class="content">
    ...
    <div class="content_right" id="content_right">
    	<h4 align="center">护士人员信息区</h4>&nbsp;&nbsp;&nbsp;
   	<form action="" method="post">
   		<input type="text" name="search"  placeholder="请输入护士姓名" required><input type="submit"  value="搜索">&nbsp <input type="button" onclick="toaddNurse()" value="添加" id="n1">
   	</form>
   	<table  border="1">
    <tr>
      <th>编号</th>
      ...
      <th>操作</th>
						...
						<td><a href = "ModifyNurse?nNo=${nurse.nNo }">修改</td>
      					<td><a href="">离职办理</a></td>
					</tr>				
