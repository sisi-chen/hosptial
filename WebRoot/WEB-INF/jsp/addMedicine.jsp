...
.title{ width:100%; height:70px; border:1px solid #C33; margin-top:20px;background:-webkit-gradient(linear, 0% 0%, 0% 100%,from(#0ff0f0),to(#fff00f));}
...
<div class="content">
    ...
    <div class="content_right" id="content_right">
   	...
   	<form action="" method="post">
   		<input type="text" name="search"  placeholder="请输入药品名称" required><input type="submit"  value="搜索">
   	</form>
   	<body>
		<form action="" method="post">
			<table  border="1">
	...
	<tr>
      <td>类别</td>
	  <td><input type="text" name="MClass"></td>
	</tr>
	<tr>
      <td>数量</td>
	...
	<tr> 
     ...
     <tr colspan="2">
      <td><input type="submit" value="确认">&nbsp;<input type="button" value="返回" onClick=""></a></td>
    </tr>
	</table>
		</form>
    </div>
