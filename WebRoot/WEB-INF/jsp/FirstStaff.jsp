...
<html>
  <head>
    ...
    <title>My JSP 'FirstStaff.jsp' starting page</title>
...
<script type="text/javascript">
  	 ...
  	 function toManagementHospital()
  	 {
    	window.location.href = 'ManagementHospital';
  	 }
  	  function toManagementMedicine()
  	 {
    	window.location.href = 'ManagementMedicine';
  	 }
...
<div class="content">
	<div class="content_left" id="content_left">
    	<ul>
            ...
            <li id="a2"><input type="button" id="b2" value="住院部管理" onclick="toManagementHospital()"/></li>
            <li id="a3"><input type="button" id="b3" value="药品管理" onclick="toManagementMedicine()"/></li>
